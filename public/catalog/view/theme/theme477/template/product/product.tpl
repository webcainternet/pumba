...
<?php echo $column_left; ?>
	...
	<div class="col-sm-8"><?php } else { ?><div class="col-sm-12"><?php } ?>
	  ...
	  <div class="cart">
		<div class="prod-row">
			<div class="cart-top">
				...
				<div class="extra-button">
					<div class="wishlist">
						<a class="tooltip-1 button" title="<?php echo $button_wishlist; ?>" onclick="addToWishList('<?php echo $product_id; ?>');">
							<i class="fa fa-star"></i>
						</a>
					</div>
					<div class="compare">
						<a class="tooltip-1 button" title="<?php echo $button_compare; ?>" onclick="addToCompare('<?php echo $product_id; ?>');">
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme477/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
  ...
  <div  class="related">
	<div class="box-product">
		...
		<ul class="related-slider">
			...
			<div class="padding">
			<div class="image">
				<a href="<?php echo $product['href']; ?>"><?php if ($product['thumb']) { ?><img id="img_<?php echo $product['product_id']; ?>" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /><?php } else{ ?><img src="catalog/view/theme/theme477/image/no-image.png" alt="" /><?php } ?></a>
			</div>
			<div class="inner">
				...
				<div class="cart-button">										
					<div class="wishlist"><a class="tooltip-2 button" title="<?php echo $button_wishlist; ?>" onclick="addToWishList('<?php echo $product['product_id']; ?>');">
						<i class="fa fa-star"></i>
						</a>
					</div>
					<div class="compare"><a class="tooltip-2 button" title="<?php echo $button_compare; ?>" onclick="addToCompare('<?php echo $product['product_id']; ?>');">
						<i class="fa fa-signal"></i>
						</a>
					</div>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme477/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme477/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
