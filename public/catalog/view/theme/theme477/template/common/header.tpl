...
$.src="//v2.zopim.com/?330Jl7Fuh0XEpSoZvKthpa0uaiF6srNr";z.t=+new Date;$.
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.3&appId=1427063280945050";
	...
	<div id="page">
		...
		<!-- Container -->
			<div id="container">
				...
				<div class="container">
					<?php if (!empty($error)) { ?>
					<div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme477/image/close-1.png" alt="" class="close" /></div>
					<?php } ?>
